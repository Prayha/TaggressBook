...
<%
    ...
    String WhereDefault = "select aSeqno, aName, aImage, aPNum, aEmail, aMemo, aTag from address where user_uSeqno = (select uSeqno from user where uId = '" + userid + "') AND (aName like '%" + searchtxt + "%' OR aPNum like '%" + searchtxt + "%' OR aEmail like '%" + searchtxt + "%' OR aMemo like '%" + searchtxt + "%')";
    int count = 0;
